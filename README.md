...
BONUS Story #2: My calculator should contain a clickable element with an id='delete' that deletes the last digit and or operator

BONUS Story #3: Handle brackets
